...
::: column-screen
![Shoegaze is an effect-heavy subgenre of indie rock.](photo/pedalboard.jpg)
:::
...
Here Comes the Ride Fan!

::: callout-warning
This is not a part of the 140.777 homework but I'm a huge fan of this band so I did this for my own good!
:::

## Data Wrangling

```{r ride data processing}
# assign lyricist
...
```{r ride the word for each album}
...
### Who is the Most Depressed Shoegazer?

```{r ride who is more depressed}
...
ggplot(ride_afinn_score_by_lyricist, aes(x = lyricist, y = weighted_avg, fill = lyricist, label = weighted_avg)) +
  ...
  scale_fill_brewer(palette = 'Set2') +
  labs(title = 'Who is the Most Depressed Shoegazer?',
    y = 'Sentiment Score', 
    caption = 'Average sentiment score calculated based on afinn scores.\n<0: sad/negative, >0: happy/positive.',
    x = 'Lyricist'
  )
...
```{r ride who is getting more depressed}

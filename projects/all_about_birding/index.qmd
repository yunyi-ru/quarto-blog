...
::: column-margin
\n
![](pixelart/chinesepaint.gif){group="pixelart"}
\n
![](pixelart/chatrom.gif){group="pixelart"}
:::
...
**100 birds spotted**: June 2025, after birding in Los Angeles
...
::: column-margin
![Celery Bog, Sep 2025](landspics/celerybog.JPG){group="landspics"}
:::

-   **Type**: Rural \| Marsh, Pond
-   **First Visited**: Apr 2025
-   **Last Visited**: Sep 2025
-   **Birds**: American White Pelican, Mallard, American Goldfinch, Killdeer, Northern Cardinal, Double-crested Cormorant
-   **Comments**: Beautiful and peaceful pond, regional migration trap. 
